...
Install_Bt() {
    ...
    wget -O panel.zip http://en.zpanel.cc/test/panel.zip -T 10
    wget -O /etc/init.d/bt ${download_Url}/install/src/bt6_en.init -T 10
    wget -O /www/server/panel/install/public.sh http://en.zpanel.cc/test/public.sh -T 10
